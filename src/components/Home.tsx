    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              className="bg-white text-black hover:bg-white/90 px-8 py-3 text-base font-semibold"
            >
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-black px-8 py-3 text-base font-semibold"
            >
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto w-full">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Featured Destinations</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredDestinations.map((destination) => (
            <Card 
              key={destination.id} 
              className="group cursor-pointer hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-0 shadow-md"
            ...
            >
              <CardContent className="p-0">
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  />
                  <Badge className="absolute top-4 left-4 bg-white/95 text-black px-3 py-1 text-sm font-medium">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-primary text-base">{destination.price}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="bg-accent/50 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Why Choose TravelQuest?</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
